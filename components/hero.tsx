  ...
  return (
    <div className="relative grid gap-5 sm:gap-6 md:grid-cols-5 items-start">
      ...
      <div className="md:col-span-5 flex flex-col gap-4">
        ...
        <div
          className="flex gap-3 overflow-x-auto py-2 snap-x snap-mandatory -mr-4 pr-4 overscroll-x-contain"
          aria-label="Outcome domains"
          role="list"
        >
          {conditions.map((c) => (
            <div key={c.id} className="snap-start shrink-0" role="listitem">
